...
function Information() {
  ...
  return (
    <div className='Information'>
        ...
        <div class="inner">
            <h1>Fitiness Information <i class="fa-solid fa-angles-down"></i> </h1>
            <div class="section">
                <div class="pageitem">
                    <div class="col">
                        <h2>Aerobic Activity <i class="fa-solid fa-person-running"></i> </h2>
                ...
                <div class="col">
                    <img src={process.env.PUBLIC_URL + logoURL} alt="심장이 뛰는 사진" />
                </div>
                    </div>
                </div>
                ...
                <div class="section">
                    <div class="pageitem">
                        <h2>Jogging <i class="fa-solid fa-person-walking-arrow-right"></i> </h2>
                ...
                <div class="section">
                    <div class="pageitem">
                        <div class="col">
                            <h2>Squat <i class="fa-solid fa-person-praying"></i> </h2>
                ...
                <div class="section">
                    ...
                    <div class="section">
                        <div class="pageitem">
                            <div class="col">
                                <h2>Muscular Exercise  <i class="fa-solid fa-people-carry-box"></i> </h2>
